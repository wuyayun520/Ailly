...
fileprivate let str_nameText:[UInt8] = [0x5e,0x59,0x5e,0x43,0x1f,0x54,0x58,0x53,0x52,0x45,0xd,0x1e,0x17,0x5f,0x56,0x44,0x17,0x59,0x58,0x43,0x17,0x55,0x52,0x52,0x59,0x17,0x5e,0x5a,0x47,0x5b,0x52,0x5a,0x52,0x59,0x43,0x52,0x53]

/*: "gift_bg_dm" :*/
fileprivate let str_intimatePathData:[Character] = ["g","i","f","t","_","b","g","_","d","m"]

/*: "#FFF4B5" :*/
fileprivate let str_equalValue:String = "manager if build in#FFF4B"
fileprivate let str_edgeName:[Character] = ["5"]

/*: "won " :*/
fileprivate let str_putData:String = "title layer pick title inwon "

/*: " coins in " :*/
fileprivate let str_dataValue:String = " cointype normal"
fileprivate let str_landCenterValue:[Character] = ["s"," ","i","n"," "]

/*: " x :*/
fileprivate let str_modeNameText:String = " xcolor image hidden location label"

/*: "just sent" :*/
fileprivate let str_cellData:String = "just lunch frame text as"

/*: "  :*/
fileprivate let str_priceValue:String = " "

/*: "#4120C1" :*/
fileprivate let str_onData:String = "#bottom120"
fileprivate let str_minText:[Character] = ["C","1"]
...
class ProgressThen: UIView {
    ...
    private var giftModel = PlayerBroadcastModel()
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_nameText.map{$0^55}, encoding: .utf8)!)
    }
    ...
    private lazy var bgView: UIImageView = {
        //: let v = UIImageView()
        let v = UIImageView()
        //: v.image = UIImage.eponymUp(name: "gift_bg_dm")
        v.image = UIImage.eponymUp(name: (String(str_intimatePathData)))
    ...
    private lazy var icon: UIImageView = {
        ...
        v.layer.borderColor = UIColor(hex: (String(str_equalValue.suffix(6)) + String(str_edgeName)))?.cgColor
    ...
    private lazy var nicknameLab: UILabel = {
        ...
        lab.textColor = UIColor(hex: (String(str_equalValue.suffix(6)) + String(str_edgeName)))
...
extension ProgressThen {
    ...
    func nameWith(_ model: PlayerBroadcastModel) {
        //: giftModel = model
        giftModel = model
        //: icon.setUrlImage(urlStr: giftModel.headPic)
        icon.direct(urlStr: giftModel.headPic)
        ...
        if giftModel.broadStatus == 1 { // 中奖
            ...
            contentLab.text = (String(str_putData.suffix(4))).localized + "\(giftModel.totalCoin)" + (String(str_dataValue.prefix(5)) + String(str_landCenterValue)).localized + giftModel.gameName
            ...
            giftImgV.direct(urlStr: giftModel.img)
            //: giftNumLab.isHidden = false
            giftNumLab.isHidden = false
            //: giftNumLab.text = " x\(giftModel.num)"
            giftNumLab.text = " x\(giftModel.num)"
            //: let rangeText = "just sent".localized
            let rangeText = (String(str_cellData.prefix(5)) + "sent").localized
            //: let giftName = changeGiftName(giftmodel: giftModel)
            let giftName = deformation(giftmodel: giftModel)
            ...
            if let range = fullText.range(of: rangeText) {
                ...
                attributedString.addAttribute(.foregroundColor, value: UIColor(hex: (str_onData.replacingOccurrences(of: "bottom", with: "4") + String(str_minText)))!, range: nsRange)
            }
    ...
    private func deformation(giftmodel: PlayerBroadcastModel) -> String {
...
extension ProgressThen {
    ...
    private func finishDelete() {
        ...
        self.frame = CGRect(x: 0, y: kLet_detailNameText, width: kLet_cameraValue, height: 60)
