...
fileprivate let str_flexibleObjectAppValue:[UInt8] = [0xae,0xa9,0xae,0xb3,0xef,0xa4,0xa8,0xa3,0xa2,0xb5,0xfd,0xee,0xe7,0xaf,0xa6,0xb4,0xe7,0xa9,0xa8,0xb3,0xe7,0xa5,0xa2,0xa2,0xa9,0xe7,0xae,0xaa,0xb7,0xab,0xa2,0xaa,0xa2,0xa9,0xb3,0xa2,0xa3]

private func shadowShow(button num: UInt8) -> UInt8 {
    return num ^ 199
}

/*: "Enter phone number" :*/
fileprivate let str_sourceText:[Character] = ["E","n","t","e","r"," "]
fileprivate let str_topValue:[Character] = ["p","h","o","n","e"," ","n","u","m","b","e","r"]

/*: "Enter Email Address" :*/
fileprivate let str_iconData:String = "data pathEnter"
fileprivate let str_userData:String = "l Addrstring extension"
fileprivate let str_stageFirstValue:String = "ecell"

/*: "F4F4F4" :*/
fileprivate let str_modelText:String = "f4f4f"
fileprivate let str_detailValue:String = "4"

/*: "America(+1)" :*/
fileprivate let str_interactionData:String = "Ameriframe big text make hi"
fileprivate let str_labText:String = "draw"
fileprivate let str_withName:String = "a(+1)selected in first"

/*: "area_code_down_icon" :*/
fileprivate let str_titleAspectName:String = "add user make class colorarea_"
fileprivate let str_micName:String = "own_iconsession height camera view"

/*: "BBBBBB" :*/
fileprivate let str_pageText:String = "modelmodelmodelmodelmodel"
fileprivate let str_toMakeTitle:String = "b"

/*: "btn_field_delete_icon" :*/
fileprivate let str_viewData:String = "btn_fiprint make"
fileprivate let str_hiddenData:String = "size timete_icon"

/*: "Password" :*/
fileprivate let str_currentCellValue:[Character] = ["P","a","s","s","w","o","r","d"]

/*: "CCCCCC" :*/
fileprivate let str_colorValue:String = "cccccc"

/*: "or" :*/
fileprivate let str_modelValue:String = "changer"

/*: "F5F5F5" :*/
fileprivate let str_toTitle:String = "logloglog"

/*: "Next" :*/
fileprivate let str_birthdayTitle:[Character] = ["N","e","x","t"]

/*: "Login by password" :*/
fileprivate let str_nameData:String = "frame image let window withLogi"
fileprivate let str_specialTitle:String = "sswoshared"

/*: "Login by OTP" :*/
fileprivate let str_videoData:String = "Login down new var"
fileprivate let str_outsideTitle:String = "view"

/*: "#8C7AFF" :*/
fileprivate let str_photoText:[Character] = ["#","8","C","7","A","F","F"]

/*: "Login" :*/
fileprivate let str_topContent:[Character] = ["L","o","g","i","n"]

/*: "Send verification" :*/
fileprivate let str_behaviorData:String = "Sendtitle add succeed"
fileprivate let str_modelViewValue:String = "selectation"
...
class IndexFieldDelegate: UIView, UITextFieldDelegate {
    ...
    init(type: GiftLoginType) {
        ...
        queryReleaseBodyPolitic()
    }

    //: required init?(coder: NSCoder) {
    required init?(coder _: NSCoder) {
        //: fatalError("init(coder:) has not been implemented")
        fatalError(String(bytes: str_flexibleObjectAppValue.map{shadowShow(button: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var titleLabel: UILabel = {
        ...
        label.text = self.loginType == .LoginPhone ? (String(str_sourceText) + String(str_topValue)).localized : (String(str_iconData.suffix(5)) + " Emai" + String(str_userData.prefix(6)) + str_stageFirstValue.replacingOccurrences(of: "cell", with: "ss")).localized
        //: return label
        return label
        //: }()
    }()
    ...
    private lazy var areaCodeControl: UIControl = {
        ...
        control.backgroundColor = UIColor(hex: (str_modelText.uppercased() + str_detailValue.capitalized))
    ...
    lazy var areaCodeLabel: UILabel = {
        ...
        label.text = (String(str_interactionData.prefix(5)) + str_labText.replacingOccurrences(of: "draw", with: "c") + String(str_withName.prefix(5)))
        //: return label
        return label
        //: }()
    }()
    ...
    private lazy var areaDownImgView: UIImageView = {
        ...
        imageView.image = UIImage.eponymUp(name: (String(str_titleAspectName.suffix(5)) + "code_d" + String(str_micName.prefix(8))))
        //: return imageView
        return imageView
        //: }()
    }()
    ...
    private lazy var phoneInputView: UITextField = {
        ...
        textField.backgroundColor = UIColor(hex: (str_modelText.uppercased() + str_detailValue.capitalized))
        ...
        textField.attributedPlaceholder = NSAttributedString(string: "", attributes: [NSAttributedString.Key.font: UIFont.pingfang(type: .Regular, fontSize: 17), NSAttributedString.Key.foregroundColor: UIColor(hex: (str_pageText.replacingOccurrences(of: "model", with: "B") + str_toMakeTitle.uppercased()))!])
    ...
    private lazy var phoneDeleteBtn: UIButton = {
        ...
        btn.setImage(UIImage.eponymUp(name: (String(str_viewData.prefix(6)) + "eld_dele" + String(str_hiddenData.suffix(7)))), for: .normal)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var pwdTitleLab: UILabel = {
        ...
        lab.text = (String(str_currentCellValue)).localized
    ...
    lazy var otherLabel: UILabel = {
        ...
        label.textColor = UIColor(hex: (str_colorValue.uppercased()))
    ...
    lazy var otherLeftLine: UIView = {
        ...
        view.backgroundColor = UIColor(hex: (str_toTitle.replacingOccurrences(of: "log", with: "F5")))
        //: return view
        return view
        //: }()
    }()
    ...
    lazy var commitButton: UIButton = {
        ...
        btn.setTitle((String(str_birthdayTitle)).localized, for: .normal)
    ...
    private lazy var loginStyleBtn: UIButton = {
        ...
        btn.setTitleColor(UIColor.plaster(), for: .selected)
        //: btn.setTitle("Login by password".localized, for: .normal)
        btn.setTitle((String(str_nameData.suffix(4)) + "n by pa" + str_specialTitle.replacingOccurrences(of: "share", with: "r")).localized, for: .normal)
        //: btn.setTitle("Login by OTP".localized, for: .selected)
        btn.setTitle((String(str_videoData.prefix(6)) + "by OT" + str_outsideTitle.replacingOccurrences(of: "view", with: "P")).localized, for: .selected)
        //: btn.addTarget(self, action: #selector(loginStyleButtonClick(sender:)), for: .touchUpInside)
        btn.addTarget(self, action: #selector(dismissBlock(sender:)), for: .touchUpInside)
        //: btn.layer.cornerRadius = 25
        btn.layer.cornerRadius = 25
        //: btn.layer.borderWidth = 2
        btn.layer.borderWidth = 2
        //: btn.layer.borderColor = UIColor(hex: "#8C7AFF")?.withAlphaComponent(0.6).cgColor
        btn.layer.borderColor = UIColor(hex: (String(str_photoText)))?.withAlphaComponent(0.6).cgColor
        //: return btn
        return btn
        //: }()
    }()
...
extension IndexFieldDelegate {
    /// 更新提交按钮状态
    //: func checkCommitButtonState() {
    func queryReleaseBodyPolitic() {
        //: var isEnabled = false
        var isEnabled = false
    ...
    @objc private func dismissBlock(sender: UIButton) {
        ...
        if sender.isSelected == true { // pwd
            ...
            commitButton.setTitle((String(str_topContent)).localized, for: .normal)
            //: } else {
        } else { // OTP
            //: commitButton.setTitle("Next".localized, for: .normal)
            commitButton.setTitle((String(str_birthdayTitle)).localized, for: .normal)
        }
    ...
    func straddle() {
        ...
        commitButton.setTitle((String(str_behaviorData.prefix(4)) + " verif" + str_modelViewValue.replacingOccurrences(of: "select", with: "ic")).localized, for: .normal)
    }
}
