...
enum VariantSchemaConvertible: String {
    //: case AppleLogin
...
/// 性别
//: enum Gender: String {
enum RunReplaceableCollection: String {
    //: case unknown = "0"
    case unknown = "0"
    //: case male    = "1"
    case male = "1"
...
enum UserKeyRepresentable: String {
    //: case unknown = "-1"       // 未申请
    case unknown = "-1" // 未申请
...
enum SourceCurrentCountLiteral: Int {
    //: case isOnGoing = 0
...
enum SkinNameDoingsetTarget: Int {
    //: case unknown    = 0
    case unknown = 0
    //: case social     = 1
    case social = 1 // 社交礼物
...
@objc enum PhaseOfTheMoonPropertyProtocol: Int {
    //: case normal  = 0
    case normal = 0 // 默认模式
    //: case special = 1
    case special = 1 // 审核模式
...
@objc public enum BringValueConvertible: Int {
    //: case Unavailable = 0
...
enum BottomCaseIterable: CaseIterable {
...
enum GestureSignedMagnitude: Int {
    //: case nor = 1
    case nor = 1
    //: case match = 2
    case match = 2
