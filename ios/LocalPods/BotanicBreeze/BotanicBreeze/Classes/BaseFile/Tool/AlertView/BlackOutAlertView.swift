...
fileprivate let str_dataScreenContent:String = "btn_view data self let"
fileprivate let str_detailTitle:String = "show room color selfck_conti"
fileprivate let str_effectName:String = "nuser"

/*: "init(coder:) has not been implemented" :*/
fileprivate let str_imageTitle:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]
...
class BlackOutAlertView: UIView {
    ...
    private lazy var leftBtn: UIButton = {
        ...
        leftBtn.addTarget(self, action: #selector(imageToClick), for: .touchUpInside)
        //: return leftBtn
        return leftBtn
        //: }()
    }()
    ...
    private lazy var rightBtn: UIButton = {
        ...
        rightBtn.addTarget(self, action: #selector(beforeSnap), for: .touchUpInside)
        //: return rightBtn
        return rightBtn
        //: }()
    }()
         ...
         config: AtAlertConfig)
    {
        ...
        if leftBtnTitle == nil && leftBtnAttributedTitle == nil {
            ...
            alertConfig.rightBackgroundImage = (String(str_dataScreenContent.prefix(4)) + "me_ba" + String(str_detailTitle.suffix(8)) + str_effectName.replacingOccurrences(of: "user", with: "ue"))
        }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_imageTitle.reversed(), encoding: .utf8)!)
    }

    //: func changeRightBtn(title: String, isTouch: Bool) {
    func mediumText(title: String, isTouch: Bool) {
