...
fileprivate let str_frameViewTitle:[UInt8] = [0xa5,0xa2,0xa5,0xb8,0xe4,0xaf,0xa3,0xa8,0xa9,0xbe,0xf6,0xe5,0xec,0xa4,0xad,0xbf,0xec,0xa2,0xa3,0xb8,0xec,0xae,0xa9,0xa9,0xa2,0xec,0xa5,0xa1,0xbc,0xa0,0xa9,0xa1,0xa9,0xa2,0xb8,0xa9,0xa8]

private func equalUpAdd(inside num: UInt8) -> UInt8 {
    return num ^ 204
}

/*: "Any" :*/
fileprivate let str_colorValue:String = "var sex object index caseAny"
...
class OverdoPickView: EmancipatedThen {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_frameViewTitle.map{equalUpAdd(inside: $0)}, encoding: .utf8)!)
    }
    ...
    override func observerWith(button: UIButton) {
        ...
        if selectedValue.count <= 0 {
            ...
            selectedValue = dataArr.first ?? (String(str_colorValue.suffix(3)))
        }
...
extension OverdoPickView {
    /// 默认选中
    //: func normalSelectedComponent(value: String) {
    func electValue(value: String) {
...
extension OverdoPickView: UIPickerViewDelegate, UIPickerViewDataSource {
