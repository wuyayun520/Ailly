...
class StreetwiseReactiveCompatible: UILabel {
    ...
    //: private func setup() {
    private func loadSectionSetup() {
        //: translatesAutoresizingMaskIntoConstraints = false
        translatesAutoresizingMaskIntoConstraints = false
        //: layer.backgroundColor = UIColor.msgTipsColor().cgColor
        layer.backgroundColor = UIColor.trim().cgColor
        //: textColor = .white
        textColor = .white
        //: font = UIFont.pingfangFont(type: .Medium, fontSize: 11)
        font = UIFont.pingfang(type: .Medium, fontSize: 11)
