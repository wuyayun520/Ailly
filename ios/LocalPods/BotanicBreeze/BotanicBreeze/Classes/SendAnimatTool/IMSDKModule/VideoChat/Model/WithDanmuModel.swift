...
let kLet_screenName = actualWidth(w: 275)
//: let VideoMsgTableViewHeight =  actualWidth(w: 200)
let kLet_conversationMessageDeviceName = actualWidth(w: 200)
//: let VideocellLineSpeing = 3
let kLet_viewText = 3 /// cell间距

//: struct TalkingVideoCallDanmuModel: HandyJSON {
struct WithDanmuModel: HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var senderUid = ""
    var senderUid = ""
