...
class ArrayAnimationView: LengthView {
    ...
    override func hold() {
        ...
        let filePath = WithShadowAnimatTool.shared.fileVideo(fileName: (self.giftEffectModel?.mainFile)!, model: self.effectMsgModel!)
        ...
        parser?.parse(with: data! as Data, cacheKey: key, completionBlock: { [weak self] videoItem in
            ...
            self.delegate?.futurism(effectItemView: self, success: true)
...
extension ArrayAnimationView: SVGAPlayerDelegate {
