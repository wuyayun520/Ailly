...
fileprivate let str_modeValue:[UInt8] = [0xe0,0xe7,0xe0,0xfd,0xa1,0xea,0xe6,0xed,0xec,0xfb,0xb3,0xa0,0xa9,0xe1,0xe8,0xfa,0xa9,0xe7,0xe6,0xfd,0xa9,0xeb,0xec,0xec,0xe7,0xa9,0xe0,0xe4,0xf9,0xe5,0xec,0xe4,0xec,0xe7,0xfd,0xec,0xed]

private func makeView(player num: UInt8) -> UInt8 {
    return num ^ 137
}
...
class ListMiniView: GildTheLilyView {
    // 播放结束Block
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_modeValue.map{makeView(player: $0)}, encoding: .utf8)!)
    }
...
extension ListMiniView {
    ...
    func objectSearch(liveUrl: String) {
...
extension ListMiniView: TXLivePlayListener {
