...
fileprivate let str_aTitle:[UInt8] = [0xce,0xd3,0xce,0xd9,0x8d,0xc8,0xd4,0xc9,0xca,0xd7,0x9f,0x8e,0x85,0xcd,0xc6,0xd8,0x85,0xd3,0xd4,0xd9,0x85,0xc7,0xca,0xca,0xd3,0x85,0xce,0xd2,0xd5,0xd1,0xca,0xd2,0xca,0xd3,0xd9,0xca,0xc9]

fileprivate func equalTap(table num: UInt8) -> UInt8 {
...
/*: "icon_tc_warn" :*/
fileprivate let str_dataName:String = "max"
fileprivate let str_iconTitle:String = "con_ttext self in error"

/*: "Live Warning" :*/
fileprivate let str_userLabPlayerName:[Character] = ["L","i","v","e"," ","W","a"]
fileprivate let str_sizeTitle:String = "tooling"

/*: "OK" :*/
fileprivate let str_backgroundData:String = "Oapp"

/*: "Violation Reason: " :*/
fileprivate let str_titleData:[Character] = ["V","i","o","l","a"]
fileprivate let str_fromValue:String = "TION"
fileprivate let str_maxName:String = "self equal data info leton: "

/*: "Warning Time: " :*/
fileprivate let str_shareText:[Character] = ["W","a","r","n","i","n","g"," ","T","i"]
fileprivate let str_addShowViewValue:[Character] = ["m","e",":"," "]
...
class TitleAddView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_aTitle.map{equalTap(table: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var topIcon: UIImageView = {
        ...
        let iamg = UIImageView()
        //: iamg.image = UIImage.eponymUp(name: "icon_tc_warn")
        iamg.image = UIImage.eponymUp(name: (str_dataName.replacingOccurrences(of: "max", with: "i") + String(str_iconTitle.prefix(5)) + "c_warn"))
    ...
    private lazy var titleLab: UILabel = {
        ...
        lab.text = (String(str_userLabPlayerName) + str_sizeTitle.replacingOccurrences(of: "tool", with: "rn")).localized
        //: return lab
        return lab
        //: }()
    }()
    ...
    private lazy var okBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(resumeDismiss), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension TitleAddView {
    ...
    func setList(content: String, reason: String, time: String) {
        //: contentLab.text = content
        contentLab.text = content

        //: let attributes = [.foregroundColor: UIColor.appThemeColor()] as [NSAttributedString.Key: Any]
        let attributes = [.foregroundColor: UIColor.plaster()] as [NSAttributedString.Key: Any]
        //: var reasonText = "Violation Reason: ".localized
        var reasonText = (String(str_titleData) + str_fromValue.lowercased() + " Reas" + String(str_maxName.suffix(4))).localized
        ...
        var timeText = (String(str_shareText) + String(str_addShowViewValue)).localized
