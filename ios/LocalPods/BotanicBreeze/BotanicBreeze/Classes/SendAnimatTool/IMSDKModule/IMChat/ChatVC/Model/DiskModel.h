...
/*!消息体数据*/
//: @class NeedSaveJsonModel, TalkingModel, UtiliserJsonModel, AbTalkingChatMsgGiftModel, TextModel, SoulCacheModel, ImageArrayModel, PlayCollectionModel, AbTalkingChatMsgCustomSendModel, AbTalkingChatMsgQuoteModel, AbTalkingChatMsgQuoteDataModel, WantGiftModel;
@class NeedSaveJsonModel, TalkingModel, UtiliserJsonModel, AutomaticallyJsonModel, TextModel, SoulCacheModel, ImageArrayModel, PlayCollectionModel, FromJsonModel, StorageMediumModel, AJsonModel, StreetSmartJsonModel;

//: @interface DiskModel : BaseJsonModel
@interface DiskModel : BaseJsonModel

//: @property (nonatomic, strong)NeedSaveJsonModel *msgInfo;
@property (nonatomic, strong)NeedSaveJsonModel *msgInfo;

//: @property (nonatomic, strong)TalkingModel *user;
@property (nonatomic, strong)TalkingModel *user;

//: @property (nonatomic, strong)UtiliserJsonModel *toUser;
@property (nonatomic, strong)UtiliserJsonModel *toUser;

//: @property (nonatomic, strong)AbTalkingChatMsgGiftModel *gift;
@property (nonatomic, strong)AutomaticallyJsonModel *gift;

//: @property (nonatomic, strong)TextModel *tips;
@property (nonatomic, strong)TextModel *tips;

//: @property (nonatomic, strong)AbTalkingChatMsgQuoteModel *quoteMsgInfo;
@property (nonatomic, strong)StorageMediumModel *quoteMsgInfo;

//: @property (nonatomic, strong)SoulCacheModel *userInfoModel;
@property (nonatomic, strong)SoulCacheModel *userInfoModel;
...
//: @interface NeedSaveJsonModel : BaseJsonModel
@interface NeedSaveJsonModel : BaseJsonModel
...
//: @property (nonatomic, strong) ImageArrayModel *intimatePhoto; 
@property (nonatomic, strong) ImageArrayModel *intimatePhoto; /// 有该字段表示为私密照片
//: @property (nonatomic, strong) PlayCollectionModel *video; 
@property (nonatomic, strong) PlayCollectionModel *video; /// 有该字段表示是视频消息
//: @property (nonatomic, strong) AbTalkingChatMsgCustomSendModel *customSend; 
@property (nonatomic, strong) FromJsonModel *customSend; /// 保存自定义发送字段（用于失败重发）

//: @property (nonatomic, strong) WantGiftModel *wantGift; 
@property (nonatomic, strong) StreetSmartJsonModel *wantGift; /// 想要礼物
...
/// 私密照片模型
//: @interface ImageArrayModel : BaseJsonModel
@interface ImageArrayModel : BaseJsonModel
...
/// 视频（包含私密视频）模型
//: @interface PlayCollectionModel: BaseJsonModel
@interface PlayCollectionModel: BaseJsonModel
...
@interface FromJsonModel: BaseJsonModel
...
//对方
//: @interface UtiliserJsonModel : BaseJsonModel
@interface UtiliserJsonModel : BaseJsonModel
...
@interface AutomaticallyJsonModel : BaseJsonModel
...
//: @interface TextModel : BaseJsonModel
@interface TextModel : BaseJsonModel
...
@interface StreetSmartJsonModel : BaseJsonModel
...
@interface StorageMediumModel : BaseJsonModel
...
@property (nonatomic, strong) AJsonModel *renderData;
...
@interface AJsonModel : BaseJsonModel
