...
//
//        let userDic = ["uid":EqualThen.share.loginUserMode.userID,"nickName":EqualThen.share.loginUserMode.nickname,"headPic":EqualThen.share.loginUserMode.headPic,"mbId":msgInfo["mbId"]]
...
//
//        if msgTypeStr == "gift" {
//            let cellData = AbSoulCellData.init(direction: (isSend ? TMsgDirection.MsgDirectionOutgoing : TMsgDirection.MsgDirectionIncoming))
//            let data = extraString.data(using: .utf8)
//            cellData.innerMessage = V2TIMManager.sharedInstance().createCustomMessage(data)
//            do {
//                let msgModel = try DiskModel.init(dictionary: tempDic)
...
//
//            let cellData = SendCellData.init(direction: (isSend ? TMsgDirection.MsgDirectionOutgoing : TMsgDirection.MsgDirectionIncoming))
//            let data = extraString.data(using: .utf8)
//            cellData.innerMessage = V2TIMManager.sharedInstance().createCustomMessage(data)
//            do {
//                let msgModel = try DiskModel.init(dictionary: tempDic)
...
//            let cellData = DataReactiveCompatible.init(direction: (isSend ? TMsgDirection.MsgDirectionOutgoing : TMsgDirection.MsgDirectionIncoming))
//            let data = extraString.data(using: .utf8)
//            cellData.innerMessage = V2TIMManager.sharedInstance().createCustomMessage(data)
//            do {
//                let msgModel = try DiskModel.init(dictionary: tempDic)
...
//            let cellData = AtHeadCellData.init(direction: (isSend ? TMsgDirection.MsgDirectionOutgoing : TMsgDirection.MsgDirectionIncoming))
//            let data = extraString.data(using: .utf8)
//            cellData.innerMessage = V2TIMManager.sharedInstance().createCustomMessage(data)
//            do {
//                let msgModel = try DiskModel.init(dictionary: tempDic)
