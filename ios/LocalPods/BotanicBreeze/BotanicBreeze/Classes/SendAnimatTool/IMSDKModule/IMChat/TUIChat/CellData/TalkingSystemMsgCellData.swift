...
@objcMembers public class TalkingSystemMsgCellData: TUIMessageCellData {
    ...
    var contentFont = UIFont.outsideAllSize(fontSize: 13)
    var contentColor = UIColor.publishView()
    ...
    public override func contentSize() -> CGSize {
        let textSize = CGSize(width: kLet_cameraValue/2, height: kLet_clickData)
