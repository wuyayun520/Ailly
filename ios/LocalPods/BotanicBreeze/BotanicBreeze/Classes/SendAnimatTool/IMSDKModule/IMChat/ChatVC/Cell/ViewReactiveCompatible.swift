...
fileprivate let str_actualName:[UInt8] = [0x47,0x4c,0x47,0x52,0x6,0x41,0x4d,0x42,0x43,0x50,0x18,0x7,0xfe,0x46,0x3f,0x51,0xfe,0x4c,0x4d,0x52,0xfe,0x40,0x43,0x43,0x4c,0xfe,0x47,0x4b,0x4e,0x4a,0x43,0x4b,0x43,0x4c,0x52,0x43,0x42]

fileprivate func viewCamera(array num: UInt8) -> UInt8 {
...
/*: "icon_chat_start" :*/
fileprivate let str_aBackCornerValue:String = "icon_cnow close extension selected data"
fileprivate let str_viewName:String = "hat_stable save else add"

/*: "icon_chat_lock" :*/
fileprivate let str_titleText:String = "view let in last supericon_cha"
fileprivate let str_modelData:[Character] = ["t","_","l","o","c","k"]

/*: "icon_chat_burned" :*/
fileprivate let str_moreText:[Character] = ["i"]
fileprivate let str_taskData:String = "import stringcon_c"
fileprivate let str_tapValue:String = "BURNED"

/*: "icon_chat_burned_shan" :*/
fileprivate let str_rawTitle:[Character] = ["i","c","o","n","_","c","h","a","t"]
fileprivate let str_topValue:String = "return if_burned"
fileprivate let str_dataOfValue:String = "in type publish_shan"

/*: "Already burned" :*/
fileprivate let str_frameName:[Character] = ["A","l","r","e","a","d","y"," ","b","u","r","n","e","d"]
...
class ViewReactiveCompatible: IndexViewCell {
    //: var videoData: ManageCellData?
    var videoData: ManageCellData?
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_actualName.map{viewCamera(array: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var playImgView: UIImageView = {
        ...
        //: imgV.contentMode = .scaleAspectFill
        imgV.contentMode = .scaleAspectFill
        //: imgV.image = UIImage.eponymUp(name: "icon_chat_start")
        imgV.image = UIImage.eponymUp(name: (String(str_aBackCornerValue.prefix(6)) + String(str_viewName.prefix(5)) + "tart"))
        //: return imgV
        return imgV
        //: }()
    }()
    ...
    private lazy var lockImgView: UIImageView = {
        ...
        //: imgV.contentMode = .scaleAspectFill
        imgV.contentMode = .scaleAspectFill
        //: imgV.image = UIImage.eponymUp(name: "icon_chat_lock")
        imgV.image = UIImage.eponymUp(name: (String(str_titleText.suffix(8)) + String(str_modelData)))
        //: return imgV
        return imgV
        //: }()
    }()
    ...
    private lazy var burnedImgView: ProgressTalkingButton = {
        ...
        imgV.setBackgroundImage(UIImage.eponymUp(name: (String(str_moreText) + String(str_taskData.suffix(5)) + "hat_" + str_tapValue.lowercased())), for: .normal)
        //: imgV.setImage(UIImage.eponymUp(name: "icon_chat_burned_shan"), for: .normal)
        imgV.setImage(UIImage.eponymUp(name: (String(str_rawTitle) + String(str_topValue.suffix(7)) + String(str_dataOfValue.suffix(5)))), for: .normal)
        //: imgV.imageAlignment = .top
        imgV.imageAlignment = .top
        //: imgV.spaceBetweenTitleAndImage = 20
        imgV.spaceBetweenTitleAndImage = 20
        //: imgV.setTitle("Already burned".localized, for: .normal)
        imgV.setTitle((String(str_frameName)).localized, for: .normal)
...
extension ViewReactiveCompatible {
    ...
    override func fill(with data: TCommonCellData) {
        ...
        super.fill(with: data)
        //: self.videoData = data as? ManageCellData
        self.videoData = data as? ManageCellData
        ...
        self.dutationLab.text = NSDate.outsideViewTime(totalTime: duration)
        ...
        self.laden(urlStr: videoModel.coverImg, isMosaic: imgIsMosaic)
    }
    ...
    func laden(urlStr: String, isMosaic: Bool) {
        //: guard let newData = self.videoData else { return }
        guard let newData = self.videoData else { return }
        ...
        if !coverImgPath.isEmptyString, isExit { // 加载本地
            ...
            //: if isMosaic {
            if isMosaic {
                //: self.picImgView.image = UIImage.giftLevel(image, with: 90)
                self.picImgView.image = UIImage.giftLevel(image, with: 90)
                //: } else {
            } else {
            ...
            self.picImgView.videoView(urlStr: urlStr) { [weak self] image in
