...
open class ListScrollView: UITextView {
    ...
    @IBInspectable open var placeholderColor: UIColor = ListScrollView.Constants.defaultiOSPlaceholderColor {
        //: didSet {
        didSet {
