...
/*: "id" :*/
fileprivate let str_colorName:[Character] = ["i","d"]
...
struct OccurrentInfoModel: HandyJSON {
    //: var uid: String = ""
    var uid: String = ""
    ...
    var momentPic: DeviceModelType?
    //: var gallery: Array<TalkingUserInfoGalleryModel>?
    var gallery: [TargetTitleHandyJSON]? // 相册
    ...
    var aiExtraInfo = RunModelType() // AI模型
    //: var vipSkinId = 0
...
struct TargetTitleHandyJSON: HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var url = ""
    var url = ""
    ...
    func addWith(compareTo: TargetTitleHandyJSON) -> Bool {
        //: return
        return
