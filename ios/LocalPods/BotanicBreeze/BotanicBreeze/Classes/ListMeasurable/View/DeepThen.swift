...
fileprivate let str_aspectData:[UInt8] = [0x74,0x73,0x74,0x69,0x35,0x7e,0x72,0x79,0x78,0x6f,0x27,0x34,0x3d,0x75,0x7c,0x6e,0x3d,0x73,0x72,0x69,0x3d,0x7f,0x78,0x78,0x73,0x3d,0x74,0x70,0x6d,0x71,0x78,0x70,0x78,0x73,0x69,0x78,0x79]

private func contentView(day num: UInt8) -> UInt8 {
    return num ^ 29
}

/*: "icon_chat_start" :*/
fileprivate let str_beginContent:[Character] = ["i","c","o","n","_","c","h","a","t","_","s","t","a","r","t"]

/*: "#752FE9" :*/
fileprivate let str_windowMakeName:[Character] = ["#","7"]
fileprivate let str_videoValue:String = "self head type52FE9"

/*: "#F5F5F5" :*/
fileprivate let str_equalAddName:[Character] = ["#","F","5","F","5","F","5"]

/*: "@ :*/
fileprivate let str_phoneName:String = "@"

/*: "btn_feed_dianzan_nor" :*/
fileprivate let str_modelValue:[UInt8] = [0x72,0x6f,0x6e,0x5f,0x6e,0x61,0x7a,0x6e,0x61,0x69,0x64,0x5f,0x64,0x65,0x65,0x66,0x5f,0x6e,0x74,0x62]

/*: "btn_feed_reply_nor" :*/
fileprivate let str_tableTitle:String = "btn_fnot phone message"
fileprivate let str_cellValue:[Character] = ["e","e","d","_","r"]
fileprivate let str_liveTitle:[Character] = ["e","p","l","y","_","n","o","r"]
...
class DeepThen: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_aspectData.map{BotanicBreeze.contentView(day: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var playView: UIImageView = {
        ...
        //: img.contentMode = .scaleAspectFill
        img.contentMode = .scaleAspectFill
        //: img.image = UIImage.eponymUp(name: "icon_chat_start")
        img.image = UIImage.eponymUp(name: (String(str_beginContent)))
        //: img.isHidden = true
        img.isHidden = true
        //: return img
        return img
    ...
    private lazy var atNickNameLab: UILabel = {
        ...
        lab.textColor = UIColor(hex: (String(str_windowMakeName) + String(str_videoValue.suffix(5))))
    ...
    private lazy var mainContentView: UIView = {
        ...
        view.backgroundColor = UIColor(hex: (String(str_equalAddName)))
...
extension DeepThen {
    ...
    func compartmentStack(_ model: ModelType) {
        //: headImgView.setUrlImage(urlStr: model.headPic, placeImg: UIImage.placeSquareBigImgBanner())
        headImgView.lineBorder(urlStr: model.headPic, placeImg: UIImage.banner())
        ...
        previewImgView.direct(urlStr: model.imageUrl)
        ...
        let typeImgStr = (model.type == 0) ? String(bytes: str_modelValue.reversed(), encoding: .utf8)! : (String(str_tableTitle.prefix(5)) + String(str_cellValue) + String(str_liveTitle))
        //: statusIcon.image = UIImage.eponymUp(name: typeImgStr)
        statusIcon.image = UIImage.eponymUp(name: typeImgStr)
...
extension DeepThen {
    ...
    private func twentyFourHourPeriod() {
        ...
        nickNameLab.snp.makeConstraints { make in
            ...
            make.width.lessThanOrEqualTo((kLet_cameraValue - 128) / 2)
        }
