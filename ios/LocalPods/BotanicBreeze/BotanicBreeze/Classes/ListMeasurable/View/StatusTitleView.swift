...
class StatusTitleView: UIView {
    ...
    lazy var contentLabel: UILabel = {
        ...
        label.font = .pingfang(type: .Regular, fontSize: 17)
...
extension StatusTitleView {
    //: func configText(text: String, isMomentDetail: Bool) {
    func inventoryItem(text: String, isMomentDetail _: Bool) {
