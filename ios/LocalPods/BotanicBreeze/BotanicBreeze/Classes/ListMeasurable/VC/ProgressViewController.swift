...
class ProgressViewController: SeamViewController {
    ...
    lazy var topView: ToView = {
        //: let view = TalkingMomentPhotosTopView(frame: CGRect.zero, type: myType ?? .normal)
        let view = ToView(frame: CGRect.zero, type: myType ?? .normal)
        //: return view
        return view
        //: }()
    }()
    ...
    lazy var bottomView: MakePlayerDelegate = {
    ...
    lazy var usePhotoView: IndexOffThen = {
        //: let v = TalkingSendIntimateInfoView(frame: CGRect.zero, type: .intimatePhoto)
        let v = IndexOffThen(frame: CGRect.zero, type: .intimatePhoto)
        //: return v
        return v
        //: }()
    }()
...
extension ProgressViewController {
    ...
    func progressModle(modle: WithMomentModel) {
        ...
        if modle.sex == nil {
            ...
            //: bottomView.isHidden = modle.sex==EqualThen.share.loginUserMode.sex
            bottomView.isHidden = modle.sex == EqualThen.share.loginUserMode.sex
        }
