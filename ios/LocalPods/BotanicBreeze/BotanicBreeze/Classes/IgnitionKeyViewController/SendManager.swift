...
/*: "&sr=6" :*/
fileprivate let str_birthdayTitle:[Character] = ["&","s","r","=","6"]
...
enum TypeTargetMirrorPath: String, CaseIterable {
...
class SendManager: NSObject {
    ...
    class func duringTap(urlType: TypeNameLiteral) -> String {
        //: var url = EqualThen.share.appConfigMode.urlH5Domain
        var url = EqualThen.share.appConfigMode.urlH5Domain
        //: switch urlType {
        switch urlType {
        //: case .RechargeFullPage:
        case .RechargeFullPage:
            //: url.append(EqualThen.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : EqualThen.share.appUserConfigMode.fullRechargePage)
            url.append(EqualThen.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : EqualThen.share.appUserConfigMode.fullRechargePage)

        //: break
        //: case .RechargeHalfPage:
        case .RechargeHalfPage:
            //: url.append(EqualThen.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : EqualThen.share.appUserConfigMode.halfRechargePage)
            url.append(EqualThen.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : EqualThen.share.appUserConfigMode.halfRechargePage)

        //: case .RechargeToVideoInitivHalfPage:
        case .RechargeToVideoInitivHalfPage:
            //: let newstr = EqualThen.share.appUserConfigMode.halfRechargePage.appending("&sr=6")
            let newstr = EqualThen.share.appUserConfigMode.halfRechargePage.appending((String(str_birthdayTitle)))
            //: url.append(EqualThen.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
            url.append(EqualThen.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
        //: default:
        default:
