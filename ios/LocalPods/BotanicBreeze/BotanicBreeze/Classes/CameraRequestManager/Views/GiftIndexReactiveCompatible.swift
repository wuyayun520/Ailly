...
fileprivate let str_eventData:[UInt8] = [0xc,0xb,0xc,0x11,0x4d,0x6,0xa,0x1,0x0,0x17,0x5f,0x4c,0x45,0xd,0x4,0x16,0x45,0xb,0xa,0x11,0x45,0x7,0x0,0x0,0xb,0x45,0xc,0x8,0x15,0x9,0x0,0x8,0x0,0xb,0x11,0x0,0x1]

private func scaleContent(to num: UInt8) -> UInt8 {
    return num ^ 101
}

/*: "iv_Guidance" :*/
fileprivate let str_midData:String = "from layer receive path letiv_Gui"

/*: "Click to view" :*/
fileprivate let str_modeData:String = "data show forClic"
fileprivate let str_positionValue:String = "verrorew"
...
// __CLOSE_PRINT__
//
//  GiftIndexReactiveCompatible.swift
//  AbroadTalking
//
...
class GiftIndexReactiveCompatible: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_eventData.map{scaleContent(to: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var contentView: UIImageView = {
        ...
        let iamg = UIImageView()
        //: iamg.image = UIImage.eponymUp(name: "iv_Guidance")
        iamg.image = UIImage.eponymUp(name: (String(str_midData.suffix(6)) + "dance"))
    ...
    private lazy var clickToViewBtn: UIButton = {
        ...
        btn.setTitle((String(str_modeData.suffix(4)) + "k to " + str_positionValue.replacingOccurrences(of: "error", with: "i")).localized, for: .normal)
...
extension GiftIndexReactiveCompatible {
